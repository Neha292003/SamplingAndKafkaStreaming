...
#window_size=350
sample_size=380 #got this from our analysis on historical data
time_sampling=30
...
def pred(df):
    # Function to perform prediction using Artificial Neural Network (ANN)
    X = []
    Y = []
